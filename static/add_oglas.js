/*document.getElementById('add_pressed').addEventListener("click", get_data);
...
function get_data(event) {
    ...
    if(checkforblank(n,c,k,o,s,p)) //sprecava prazne fieldove
    {
       ...
       addOglas(sentNaziv,sentCena,sentKategorija,sentOpis,sentStanje,sentSlika);
       //restartuje polja
...
function checkforblank(naziv,cena,kategorija,opis,stanje,slika){
    ...
    window.alert('Please confirm your picture!');
    return false;
    }
      else {
    return true;
